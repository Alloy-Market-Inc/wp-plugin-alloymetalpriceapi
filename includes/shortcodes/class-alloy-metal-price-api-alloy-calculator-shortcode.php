<?php
/**
 * [alloy_calculator] shortcode handler.
 *
...
class Alloy_Metal_Price_API_Alloy_Calculator_Shortcode {
	...
	public function render($atts) {
		...
		<div
			...
			class="js-alloy-calculator aur:mx-auto aur:w-full aur:max-w-180 aur:rounded-3xl aur:border aur:border-slate-900 aur:bg-white aur:p-5 aur:font-sans aur:shadow-[0_8px_24px_rgba(0,0,0,0.06)] sm:aur:p-6"
		...
		>
			...
			<div class="aur:grid aur:gap-4">
				<div class="aur:rounded-2xl aur:bg-slate-50 aur:p-4">
					...
					<div class="aur:text-2xl aur:font-semibold aur:text-primary">
						$<span class="js-alloy-calculator-display-price">0.00</span>
					</div>
				</div>

				<div class="aur:grid aur:gap-4 md:aur:grid-cols-2">
					<div>
						...
						<select id="<?php echo esc_attr($instance_id . '-karat'); ?>" class="js-alloy-calculator-karat aur:w-full aur:rounded-xl aur:border aur:border-slate-300 aur:bg-white aur:px-4 aur:py-3 aur:text-base aur:text-slate-900 focus:aur:border-primary focus:aur:outline-none">
					...
					<div>
						...
						<select id="<?php echo esc_attr($instance_id . '-weight-unit'); ?>" class="js-alloy-calculator-weight-unit aur:w-full aur:rounded-xl aur:border aur:border-slate-300 aur:bg-white aur:px-4 aur:py-3 aur:text-base aur:text-slate-900 focus:aur:border-primary focus:aur:outline-none">
				...
				<div>
					...
					<input
						...
						class="js-alloy-calculator-weight aur:w-full aur:rounded-xl aur:border aur:border-slate-300 aur:bg-white aur:px-4 aur:py-3 aur:text-base aur:text-slate-900 placeholder:aur:text-slate-400 focus:aur:border-primary focus:aur:outline-none"
					>
				</div>

				<div>
					<button type="button" class="js-alloy-calculator-calculate aur:inline-flex aur:w-full aur:justify-center aur:rounded-xl aur:bg-primary aur:px-4 aur:py-3 aur:text-base aur:font-semibold aur:text-white aur:transition hover:aur:bg-secondary focus:aur:outline-none">
						<?php esc_html_e('Calculate Value', 'alloy-metal-price-api'); ?>
					</button>
				</div>

				<div class="aur:grid aur:gap-3 lg:aur:grid-cols-3">
				...
				<div>
					<a class="aur:inline-flex aur:w-full aur:justify-center aur:rounded-xl aur:border aur:border-secondary aur:bg-secondary aur:px-4 aur:py-3 aur:text-base aur:font-semibold aur:text-white aur:no-underline aur:transition hover:aur:bg-primary hover:aur:border-primary" href="https://thealloymarket.com/request-a-kit/?referral_trigger=checked&amp;referral_code=GOLDCALC">
