	...
	public function render($args = array()) {
		$args = wp_parse_args(
			...
			array(
				...
				'button_class'           => 'alloy-calculator-submit aur:inline-flex aur:w-full aur:hover:cursor-pointer aur:justify-center aur:rounded-md! aur:border! aur:border-accent! aur:bg-accent! aur:px-4 aur:py-3 aur:text-base aur:font-semibold aur:text-white aur:transition-all aur:ease-in-out aur:hover:bg-white! aur:hover:text-accent! aur:focus:outline-none',
				'cta_class'              => 'alloy-calculator-kit-button aur:inline-flex aur:w-full aur:justify-center aur:rounded-md! aur:border aur:border-secondary aur:bg-secondary! aur:px-4 aur:py-5 aur:text-base aur:font-semibold aur:text-white! aur:no-underline! aur:transition-all aur:ease-in-out aur:hover:bg-white! aur:hover:text-secondary! aur:hover:border-secondary',
				'form_class'             => 'aur:grid aur:gap-4',
				'field_group_class'      => 'aur:grid aur:gap-6',
				'result_group_class'     => 'alloy-calculator-results-hidden aur:hidden aur:gap-3',
		...
		$wrapper_classes   = array('alloy-calculator-shell');
		if ($show_skeleton) {
			$wrapper_classes[] = 'alloy-calculator-shell--reserve';
			if ($classring) {
				$wrapper_classes[] = 'alloy-calculator-shell--classring';
			}
		}
		$wrapper_class     = trim(implode(' ', $wrapper_classes) . ' ' . (string) $args['wrapper_class']);
			...
			<section
				...
				<form class="<?php echo esc_attr($form_class); ?>">
					...
					<div class="<?php echo esc_attr($result_group); ?>">
						<div class="alloy-calculator-result-card alloy-calculator-result-card--market aur:rounded-2xl aur:border aur:border-slate-200 aur:bg-slate-50 aur:p-4 aur:flex aur:gap-2">
							...
							<p class="js-alloy-calculator-market-value alloy-calculator-result-value aur:m-0! aur:text-base! aur:font-semibold aur:text-slate-900!">$0.00</p>
						</div>
						<div class="alloy-calculator-result-card alloy-calculator-result-card--pawn aur:rounded-2xl aur:border aur:border-red-200 aur:bg-red-50 aur:p-4 aur:flex aur:gap-2">
							...
							<p class="js-alloy-calculator-pawn-value alloy-calculator-result-value aur:m-0! aur:text-base! aur:font-semibold aur:text-slate-900!">$0.00</p>
						</div>
						<div class="alloy-calculator-result-card alloy-calculator-result-card--alloy aur:rounded-2xl aur:border aur:border-emerald-200 aur:bg-emerald-50 aur:p-4 aur:flex aur:gap-2">
							...
							<p class="js-alloy-calculator-alloy-value alloy-calculator-result-value aur:m-0! aur:text-base! aur:font-semibold aur:text-slate-900!">$0.00</p>
						</div>
						<?php if ($classring) : ?>
					...
					<div class="js-alloy-calculator-cta alloy-calculator-results-hidden aur:hidden">
...
<?php
	...
	protected function render_inline_styles() {
		...
		return '<style>@keyframes alloyCalculatorSkeletonExit{to{opacity:0;visibility:hidden}}@keyframes alloyCalculatorPendingFallback{to{visibility:visible}}.alloy-calculator-shell{position:relative;width:100%;box-sizing:border-box}.alloy-calculator-shell--reserve{min-height:680px}body.page-id-20170 .alloy-calculator-shell--reserve{min-height:560px}.alloy-calculator-shell--classring{min-height:680px}.alloy-calculator-skeleton{position:absolute;top:0;right:0;left:0;z-index:2;pointer-events:none;animation:alloyCalculatorSkeletonExit .01s linear 3s forwards}.js-alloy-calculator[data-alloy-calculator-pending="true"]{visibility:hidden;animation:alloyCalculatorPendingFallback .01s linear 3s forwards}.js-alloy-calculator[data-alloy-calculator-pending="true"]{box-sizing:border-box;width:100%;max-width:520px;margin:0 auto;border-radius:24px;background:#fff;padding:20px;font-family:var(--aur-font-sans,"Lexend Deca",Arial,sans-serif);box-shadow:0 8px 24px rgba(0,0,0,.06)}.js-alloy-calculator[data-alloy-calculator-pending="true"] form{display:grid;gap:16px}.js-alloy-calculator[data-alloy-calculator-pending="true"] label{display:block;margin:0 0 8px;font-size:14px;font-weight:500;color:#334155}.js-alloy-calculator[data-alloy-calculator-pending="true"] select,.js-alloy-calculator[data-alloy-calculator-pending="true"] input{box-sizing:border-box;width:100%;min-height:48px;border:1px solid #cbd5e1;border-radius:6px;background:#fff;padding:12px 16px;font-size:16px;color:#0f172a}.alloy-calculator-results-hidden{display:none!important}.alloy-calculator-submit{min-height:49px;border-color:#727a82!important;background:#727a82!important;color:#fff!important;border-radius:4px!important;font-weight:700!important}.alloy-calculator-submit:hover{border-color:#616870!important;background:#616870!important;color:#fff!important}.alloy-calculator-result-card{border-radius:6px!important;padding:14px 10px!important;font-family:var(--aur-font-sans,"Lexend Deca",Arial,sans-serif}.alloy-calculator-result-card h3{font-size:18px!important;line-height:1.35!important;font-weight:700!important;color:#1f2937!important}.alloy-calculator-result-value{display:inline;font:inherit;color:inherit}.alloy-calculator-result-card--market{border-color:#c7ccd2!important;background:#eef0f3!important}.alloy-calculator-result-card--pawn{border-color:#e0c5c7!important;background:#efd4d6!important}.alloy-calculator-result-card--alloy{border-color:#bdd7c2!important;background:#d8ead9!important}.alloy-calculator-kit-button{min-height:62px;align-items:center;border-color:#df8158!important;background:#df8158!important;color:#fff!important;border-radius:7px!important;font-weight:700!important}.alloy-calculator-kit-button:hover{border-color:#d4744b!important;background:#d4744b!important;color:#fff!important}</style>';
	}
