...
class Alloy_Metal_Price_API_Calculator_Renderer {
	...
	public function render($args = array()) {
		...
		$wrapper_class     = trim('alloy-calculator-shell ' . (string) $args['wrapper_class']);
