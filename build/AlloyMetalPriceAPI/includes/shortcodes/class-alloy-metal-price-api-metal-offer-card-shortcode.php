		...
		<div class="aur:flex aur:w-full aur:justify-center aur:font-sans">
			<section
				...
				<div class="aur:mt-5 aur:flex aur:flex-wrap aur:items-center aur:justify-between aur:gap-4">
					<div class="js-metal-offer-card-note aur:text-xs aur:leading-5 aur:text-slate-600">
						<?php
						echo esc_html(
							sprintf(
								/* translators: %s: purity label like 14K. */
					...
					<button type="button" class="js-metal-offer-card-refresh aur:inline-flex aur:min-w-40 aur:justify-center aur:gap-2 aur:rounded-xl aur:border aur:border-primary aur:bg-primary aur:px-4 aur:py-3 aur:text-sm aur:font-semibold aur:text-white aur:fill-white aur:transition-all aur:ease-in-out aur:hover:cursor-pointer aur:hover:bg-white aur:hover:text-primary aur:hover:fill-primary aur:focus:outline-none">
						<span class="aur:w-4 aur:h-4" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
